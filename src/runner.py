...
def runner_nonoverlap(domain):
    # run km (nonoverlap)
    call('time ../../kmcpp/./km ../data/ppmi_links.dat ../data/%s/ppmi_coreness.dat ../data/%s/result_ppmi_nonoverlap.dat 100 1 10'\
...
def runner_overlap(domain):
    # run km_overlap
    call('time ../../kmcpp/./km_overlap ../data/ppmi_links.dat ../data/%s/ppmi_coreness.dat ../data/%s/result_ppmi_overlap.dat 10'\
        %(domain,domain), shell=True)
